...
describe("buildUrkundenDoc", () => {
  ...
  it("wraps a long comment instead of running it off the certificate", async () => {
    const longComment =
    ...
    const doc = await buildUrkundenDoc(withLongComment, { competitionName: "Test Cup", year: 2026 });
    const W = doc.internal.pageSize.getWidth();
